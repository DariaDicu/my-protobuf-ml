...
void flatGraphTest() {
	vector<vector<int> > flat_graph = buildFlatGraph(1000000);
	const FileDescriptor* file = buildDescriptorGraph(1000000, &flat_graph);
	cout << "Running test for completely disconnected graph.\n";
	run_test(file);
}

void chainGraphTest() {
	vector<vector<int> > chain_graph = buildChainGraph(1000000);
	const FileDescriptor* file = buildDescriptorGraph(1000000, &chain_graph);
...
void binaryTreeTest() {
	...
	const FileDescriptor* file = buildDescriptorGraph(1000000, &binary_tree);
...
void randomTreeTest() {
	// TODO: average over 10 runs.
	vector<vector<int> > random_tree = buildRandomTree(1000000);
	const FileDescriptor* file = buildDescriptorGraph(1000000, &random_tree);
...
void inverseBinaryTreeTest() {
	// TODO: average over 10 runs.
	vector<vector<int> > binary_tree = buildInverseBinaryTree(1000000);
	const FileDescriptor* file = buildDescriptorGraph(1000000, &binary_tree);
